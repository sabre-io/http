...
final class URLUtilTest extends \PHPUnit\Framework\TestCase
{
    public function testEncodePath(): void
    {
        ...
        $this->assertSame('%00%01%02%03%04%05%06%07%08%09%0a%0b%0c%0d%0e%0f'.
        ...
        '%60abcdefghijklmno'.
        'pqrstuvwxyz%7b%7c%7d~%7f', $newStr);

        $this->assertSame($str, decodePath($newStr));
    }
    ...
    public function testEncodePathSegment(): void
    {
        ...
        $this->assertSame($str, decodePathSegment($newStr));
    }
    ...
    public function testDecode(): void
    {
        ...
        $this->assertSame('Hello Test+Test2.txt', $newStr);
    }
    ...
    public function testDecodeUmlaut(): void
    {
        $str = 'Hello%C3%BC.txt';
        $newStr = decodePath($str);
        $this->assertSame("Hello\xC3\xBC.txt", $newStr);
    }
    ...
    public function testDecodeAccentsWindows7(): void
    {
        ...
        $newStr = decodePath($str);
        $this->assertSame(strtolower($str), encodePath($newStr));
    }
}
